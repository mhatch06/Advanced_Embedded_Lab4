...
#
# Script generated by Vivado on Thu Nov 02 09:43:06 -0600 2023
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_0 xil_defaultlib.clk_wiz_0 xil_defaultlib.glbl -log elaborate.log
}
