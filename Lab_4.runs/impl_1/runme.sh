...
HD_PWD='Z:/EENG498/Lab_4/Lab_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log acquireToHDMI.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source acquireToHDMI.tcl -notrace
