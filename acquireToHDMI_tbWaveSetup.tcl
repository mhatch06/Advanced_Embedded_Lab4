...
add_wave -into $SW_ID -color $groupColor -name "STORE TO BRAM" /acquireToHDMI_tb/uut/sw[10]
add_wave -into $SW_ID -color $groupColor -name "CH2 TRIGGER" /acquireToHDMI_tb/uut/sw[9]
add_wave -into $SW_ID -color $groupColor -name "CH1 TRIGGER" /acquireToHDMI_tb/uut/sw[8]
add_wave -into $SW_ID -color $groupColor -name "FORCED" /acquireToHDMI_tb/uut/sw[7]
add_wave -into $SW_ID -color $groupColor -name "SINGLE" /acquireToHDMI_tb/uut/sw[6]
